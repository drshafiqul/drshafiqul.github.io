...
<div style="text-align: center; padding: 3em 1em; max-width: 850px; margin: 2.5em auto;">
  <i class="fas fa-globe-americas" style="font-size: 4em; color: #0056b3; margin-bottom: 0.3em;"></i>
  <h2 style="font-size: 2em; margin-top: 0;">The Reality of Global Competition</h2>
  <p style="font-size: 1.1em; color: #333;">
    Each year, top universities receive tens of thousands of applications for a handful of funded positions. Applicants from every country, all with stellar academic records, are competing for the same spot. In this hyper-competitive environment, <strong>a high CGPA is the starting line, not the finish line.</strong> Your ability to demonstrate proven, hands-on research skill is the only true differentiator. This program is designed to give you that undeniable edge.
  </p>
</div>
...
<div style="background-color: rgba(249, 249, 249, 0.7); padding: 3em 2em; border-radius: 8px; margin-bottom: 3em;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 2em;">
    <div class="feature-card"><h3 style="margin-top:0;"><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i> Live Masterclasses</h3><p>Engage directly with me in real-time strategy sessions via Zoom/Google Meet. Demystify complex topics and get immediate answers to your most pressing questions.</p></div>
    <div class="feature-card"><h3 style="margin-top:0;"><i class="fas fa-chart-line" aria-hidden="true"></i> A High-Impact Research Portfolio</h3><p>Weekly hands-on assignments build upon each other, culminating in a publication-quality research paper—a powerful asset for your applications.</p></div>
    <div class="feature-card"><h3 style="margin-top:0;"><i class="fas fa-comments" aria-hidden="true"></i> Elite Mentorship & Feedback</h3><p>Receive detailed, line-by-line feedback on your work. Use your dedicated weekly 30-minute one-on-one consultation hour to perfect your strategy.</p></div>
    <div class="feature-card"><h3 style="margin-top:0;"><i class="fas fa-award" aria-hidden="true"></i> Verified Credential</h3><p>Earn a Certificate of Completion that signals your research readiness to admissions committees worldwide—a formal recognition of your advanced skills.</p></div>
  </div>
</div>

<!-- ======================================================================= -->
<!-- PRICING BOX SECTION - NOW WITH FLAMING RED TEXT -->
<!-- ======================================================================= -->
<div class="pricing-box urgency-box-animated" style="border: 3px solid #ffc107; background: #fffcf5; border-radius: 10px; text-align: center; padding: 2em; max-width: 700px; margin: 4em auto;">
  ...
  <div class="price" style="margin: 1.5em 0; padding: 1em; background: #fff; border-radius: 8px;">
    <span style="font-size: 1.1em; color: #666;">Standard Program Fee: <del>8,000 BDT</del></span>
    <br>
    <div style="display: flex; justify-content: center; align-items: center; gap: 0.5em; margin-top: 0.2em;">
      <i class="fas fa-fire" aria-hidden="true" style="color: #d9534f; font-size: 2.5rem;"></i>
      <strong style="font-size: 3.2em; font-weight: bold; color: #d9534f; line-height: 1.1;">5,000 BDT</strong>
    </div>
    <span style="font-weight: bold; color: #555;">(Full Program Access)</span>
  </div>
  <p style="font-size: 0.9em; color: #d9534f; font-weight: bold;">This is the lowest price this comprehensive program will ever be offered at.</p>
  <a href="https://forms.gle/Nrdd9mb3QhwoqnAS6" class="btn btn--danger btn--lg" target="_blank" rel="noopener noreferrer" style="margin-top: 1em; padding: 0.8em 2em; font-size: 1.2em; width: 100%;">Apply to Secure the Pioneer's Rate</a>
</div>
...
<div class="syllabus-table-wrapper">
  <table class="syllabus-table">
    <thead><tr><th>Module</th><th>Topics Covered</th><th>Key Outcome</th></tr></thead>
    <tbody>
...
<!-- ======================================================================= -->
<div class="value-proposition" style="max-width: 800px; margin: 4em auto; padding: 2.5em; background: #f0f8ff; border-left: 5px solid #0056b3; border-radius: 8px;">
  <h2 style="text-align: center; margin-top: 0;">Why These Skills Are Your Golden Ticket</h2>
  <p style="font-size: 1.1em;">Admissions committees at world-class universities receive thousands of applications from students with high grades. They don't look for more students who are good at memorizing theory; they look for future colleagues with <strong>proven research potential</strong>.</p>
  <p style="font-size: 1.1em;">The skills taught in this program—accessing real-world financial data from sources like WRDS, conducting rigorous econometric analysis in Stata/R, and structuring a publication-quality paper—are not just items on a syllabus. <strong>They are the hard evidence that separates you from the crowd.</strong></p>
  <p style="font-size: 1.1em;">This program gives you the ability to move beyond saying "I am interested in research" and empowers you to confidently demonstrate "I have produced high-quality research." That is the single most powerful statement you can make in your graduate school application.</p>
</div>
...
<div style="max-width: 800px; margin: 3em auto;">
  ...
  <p>Anyone from any field interested to research in business, economics, finance, and accounting (Analytics and Machine Learning focus). A basic understanding of statistics is helpful, but no prior programming experience is necessary. Your desire to do research, win a prestigious scholarship, and change your life forever is the most important prerequisite in my opinion.</p>
